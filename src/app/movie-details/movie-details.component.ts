...
export class MovieDetailsComponent implements OnInit {
  ...
  movies = [
    ...
    { id: 6, title: 'Movie 1', image: 'assets/mat1.png', description: 'Descrição do Movie 6' },
    { id: 7, title: 'Movie 2', image: 'assets/mat2.png', description: 'Descrição do Movie 7' },
    { id: 8, title: 'Movie 3', image: 'assets/mat3.png', description: 'Descrição do Movie 8' },
    { id: 9, title: 'Movie 4', image: 'assets/mat4.png', description: 'Descrição do Movie 9' },
    { id: 10, title: 'Movie 5', image: 'assets/mat5.png', description: 'Descrição do Movie 10' },
  ];
